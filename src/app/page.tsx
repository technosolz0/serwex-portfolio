...
//         description="Find trusted technicians, compare prices, and book with real ratings. For service providers, Serwex Partner makes managing bookings and prices easy."
...
//           >
//             Find trusted technicians, compare prices, and book with real ratings. For service providers, Serwex Partner makes managing bookings and prices easy.
//           </motion.p>
//           <motion.div 
//             className="space-x-4"
//             initial={{ y: 50, opacity: 0 }}
...
//             <a href="https://play.google.com/store/apps/details?id=com.serwex.partner" target="_blank" className="bg-white text-secondary px-6 py-3 rounded hover:bg-tertiary hover:text-white transition-colors shadow-glow">Download Serwex Partner (Vendors)</a>
//           </motion.div>
//         </div>
//       </motion.section>
